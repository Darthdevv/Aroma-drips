...
const SearchComponent = () => {
    ...
    return (
        <div className="h-[6.625rem] py-5 w-full flex items-center justify-between bg-[#fff] dark:bg-background-navygrey px-4">
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <input
                                ...
                                type="text"
                                placeholder="Menu"
                                className="w-full h-[3.625rem] pl-10 bg-background-gray dark:bg-background-navy rounded-full outline-none text-text-whitish placeholder:text-text-whitish font-semibold"
                            />
                        )}
                    />
                    <button
                        type="submit"
                        className="absolute right-1 h-[3.6rem] w-[9.75rem] bg-[#244937] text-white flex items-center justify-center rounded-full px-6 font-medium"
                    >
                        Search
                    </button>
                </form>
