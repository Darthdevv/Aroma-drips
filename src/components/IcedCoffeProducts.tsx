...
const IcedCoffeProducts = (): JSX.Element => {
    ...
    const handleKeyDown = (e: React.KeyboardEvent, item: typeof iceCoffeeItems[0]) => {
        ...
        if (['ArrowUp', 'ArrowDown', 'ArrowLeft', 'ArrowRight'].includes(e.key)) {
            ...
            switch (e.key) {
                case 'ArrowRight':
                    nextIndex = (currentIndex + 1) % iceCoffeeItems.length;
                    break;
                case 'ArrowLeft':
                    nextIndex = (currentIndex - 1 + iceCoffeeItems.length) % iceCoffeeItems.length;
                    break;
                case 'ArrowDown':
                    nextIndex = Math.min(currentIndex + itemsPerRow, iceCoffeeItems.length - 1);
                    break;
                case 'ArrowUp':
